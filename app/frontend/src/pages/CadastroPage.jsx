...
import { User, EnvelopeSimple, IdentificationCard, Phone } from 'phosphor-react';
...
function CadastroPage() {
    ...
    const validateForm = () => {
        ...
        if (!formData.email.trim() || !/^[^\s@]+@[\w-]+\.[a-z]{2,}$/i.test(formData.email)) newErrors.email = 'Email inválido';
        if (!formData.taxId.trim() || !/^\d{3}\.\d{3}\.\d{3}-\d{2}$/.test(formData.taxId)) newErrors.taxId = 'CPF inválido';
        if (!formData.cellphone.trim() || !/^\(\d{2}\) \d{5}-\d{4}$/.test(formData.cellphone)) newErrors.cellphone = 'Número de celular inválido';
        return newErrors;
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setPixData({data, email: formData.email}); 
            ...
            >
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <EnvelopeSimple size={20} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" />
                            <input
                                type="email"
                                id="email"
                                name="email"
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <IdentificationCard size={20} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" />
                            <input
                                type="text"
                                id="taxId"
                                name="taxId"
