...
describe("desktop bridge", () => {
  ...
  it("forwards reporting calls to the V2 reporting handler", async () => {
    ...
    const salesReport = {
      ...
      totalSalesCount: 1,
      commercialTotalMinor: 1_000,
      cogsInventoryValueMicro: 600_000,
      grossMarginInventoryValueMicro: 9_400_000,
      grossMarginBasisPoints: 9_400,
      averageCommercialTotalMinor: 1_000,
      salesRevenueSeries: [],
      ...
      purchaseSpendSeries: [
        {
          ...
          commercialTotalMinor: 500,
          inventoryValueMicro: 5_000_000,
          directCostInventoryValueMicro: 0,
          grossMarginInventoryValueMicro: 0,
        },
      ],
      topSuppliersBySpend: [],
      freeStockEntries: [],
      ...
      productionByRecipeProduct: [
        {
          ...
          directCostInventoryValueMicro: 500_000,
